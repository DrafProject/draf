...
class DataBase:
    ...
    c_Elc_inv_ = ParDat(name="c_Elc_inv_", data=1295, unit="€/kW_el", src="@Petkov_2020")
    c_FC_inv_  = ParDat(name="c_FC_inv_", data=1684, doc="CAPEX", unit="€/kW_el", src="@Petkov_2020")
    ...
    c_H2S_inv_ = ParDat(name="c_H2S_inv_", data=10, doc="CAPEX", unit="€/kWh", src="@Petkov_2020")
    c_P2H_inv_ = ParDat(name="c_P2H_inv_", data=100, doc="CAPEX", unit="€/kW_th", src="@SMT_2018")
    ...
    N_Elc_ = ParDat(name="N_Elc_", data=14, unit="a", src="@Petkov_2020")
    N_FC_ = ParDat(name="N_FC_", data=14, doc=Etypes.N.en, unit="a", src="@Petkov_2020")
    N_H2S_ = ParDat(name="N_H2S_", data=23, doc=Etypes.N.en, unit="a", src="@Petkov_2020")
