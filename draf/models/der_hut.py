...
def params_func(sc):
    ...
    sc.add_par("n_c_", 8760 / len(T), doc="cost weighting factor to compensate part year analysis", unit="")
    ...
    p.Q_dem_H_TH.loc[:, 1] = draf.io.get_thermal_demand(
        ser_amb_temp=draf.io.get_ambient_temp(2017, "60min"), annual_energy=1743000, target_temp=22, threshold_temp=13,
    )[T].values
