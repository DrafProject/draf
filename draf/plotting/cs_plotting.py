...
class CsPlotter(BasePlotter):
    ...
    def tables(self):
        cs = self.cs
        funcs = {
            "1D params ": ("p_table", "table"),
            "1D variables ": ("v_table", "table"),
            "Investments ": ("invest_table", "money"),
            "Capacities ": ("capa_table", " fa-cubes"),
            "Yields ": ("yields_table", " fa-line-chart"),
            "eGrid ": ("eGrid_table", " fa-line-chart"),
            "Pareto ": ("pareto_table", " fa-plug"),
            "BES ": ("bes_table", "fa-solid fa-battery-half"),
            "Time ": ("time_table", " fa-clock-o"),
        }
